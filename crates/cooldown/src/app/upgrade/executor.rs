...
use cooldown_core::{
    ApplyReport, CeilingReason, Change, DepScope, Dependency, Diagnostic, DiagnosticKind,
    LockStatus, PackageId, Plan, ProjectMutationJournal, ProjectMutationState, Release,
